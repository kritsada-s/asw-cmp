...
import Banner from './images/banner-d_easy-left_new-key_25-feb@2x.webp';
import BannerM from './images/banner-m_easy-left_new-key_25-feb@1.5x.webp';
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (utmFromUrl) {
      ...
      setUtmSource(`${process.env.NEXT_PUBLIC_UTM}`);
    }
  }, [searchParams]);
